...
export const UploadIcon = forwardRef(
    ({ width = '2.8rem', height = '2.8rem', className }, ref) => (
        <svg
            ref={ref}
            className={className}
            width={width}
...
export const FollowingIcon = forwardRef(
    ({ width = '3.2rem', height = '2.6rem', className }, ref) => (
        <svg
            ref={ref}
            className={className}
            width={width}
...
export const FollowingIconActive = forwardRef(
    ({ width = '3.2rem', height = '2.6rem', className }, ref) => (
        <svg
            ref={ref}
            className={className}
...
export const FriendIcon = forwardRef(
    ({ width = '3.2rem', height = '3.2rem', className }, ref) => (
        <svg
            ref={ref}
            className={className}
...
export const FriendIconActive = forwardRef(
    ({ width = '3.2rem', height = '3.2rem', className }, ref) => (
        <svg
            ref={ref}
            className={className}
